...
export class InitialSchema1779909247611 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('customer', 'driver', 'restaurant_owner')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."driver_vehicletype_enum" AS ENUM('bicycle', 'motorcycle', 'car')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "driver-location" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "driverId" uuid NOT NULL, "latitude" numeric(10,7) NOT NULL, "longitude" numeric(10,7) NOT NULL, "heading" numeric, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_96e807cd4ac54e55e295d56774" UNIQUE ("driverId"), CONSTRAINT "PK_6aa828ca99224889f30e6493119" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "driver" ADD CONSTRAINT "FK_abf4fe92b1ed7d4ffa2d4e8045a" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "driver-location" ADD CONSTRAINT "FK_96e807cd4ac54e55e295d56774f" FOREIGN KEY ("driverId") REFERENCES "driver"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "driver-location" DROP CONSTRAINT "FK_96e807cd4ac54e55e295d56774f"`,
    );
    await queryRunner.query(
